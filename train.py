...
def reallocate_wider_deep_tail_bytes_into_adapters(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 2 or model_cfg.tail_layers != 7:
        return
    ...
    model_cfg.adapter_rank = 10
    model_cfg.adapter_alpha = 20.0
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    reallocate_wider_deep_tail_bytes_into_adapters(cfg)
    return cfg
