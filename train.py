...
def replace_dense_late_qat_neighbor_branch_tip_with_selective_int4_long_context_tail_moonshot(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if not model_cfg.final_tail_neighbor_mixer or not model_cfg.tie_embeddings or model_cfg.final_tail_smear_gate:
        return
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 0 or model_cfg.recurrence_loops != 0 or model_cfg.tail_layers != 3:
    ...
    model_cfg.tail_mlp_hidden_bonuses = (
        ...
        model_cfg.d_model * 3,
        model_cfg.d_model * 7 // 2,
        model_cfg.d_model * 4,
    )
    model_cfg.q_low_rank = 0
    model_cfg.shared_q_low_rank = None
    model_cfg.final_tail_q_low_rank = None
    model_cfg.tail_q_low_ranks = (
        model_cfg.d_model // 8,
    ...
    cfg.quant.keep_float_name_patterns = (
        ...
        "tok_emb.weight",
        "tail.7.mlp.",
        "tail.7.attn.q_proj.weight",
        "tail.7.attn.out_proj.weight",
    )
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    replace_dense_late_qat_neighbor_branch_tip_with_selective_int4_long_context_tail_moonshot(cfg)
    return cfg
