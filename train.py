...
def extend_context_on_three_wider_unique_near_cap_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if not model_cfg.tie_embeddings or model_cfg.final_tail_smear_gate:
        return
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    extend_context_on_three_wider_unique_near_cap_carrier(cfg)
    return cfg
