...
def pair_attention_float_with_shared_tail_mlp_qat_relax_and_final_tail_proj_float_on_tied_embed_final_tail_q_line(
    cfg: TrainConfig,
) -> None:
    model_cfg = cfg.model
    if not model_cfg.tie_embeddings:
    ...
    if any(pattern in cfg.quant.keep_float_name_patterns for pattern in extra_float_patterns):
        return
    model_cfg.shared_mlp_fake_quant_during_train = False
    model_cfg.final_tail_mlp_fake_quant_during_train = False
    cfg.quant.keep_float_name_patterns = tuple(dict.fromkeys((*cfg.quant.keep_float_name_patterns, *extra_float_patterns)))
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    pair_attention_float_with_shared_tail_mlp_qat_relax_and_final_tail_proj_float_on_tied_embed_final_tail_q_line(cfg)
    return cfg
