...
def swap_final_tail_neighbor_for_smear_gate_on_branch_tip_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    swap_final_tail_neighbor_for_smear_gate_on_branch_tip_carrier(cfg)
