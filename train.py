...
def reallocate_low_rank_q_into_two_tail_neighbor_mixers_on_branch_tip_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    reallocate_low_rank_q_into_two_tail_neighbor_mixers_on_branch_tip_carrier(cfg)
    return cfg
