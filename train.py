...
def push_low_rank_q_harder_for_true_3p5x_carrier_on_compact_line(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 1 or model_cfg.tail_layers != 3:
        return
    ...
    model_cfg.shared_mlp_hidden_bonus = model_cfg.d_model + model_cfg.d_model // 2
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    push_low_rank_q_harder_for_true_3p5x_carrier_on_compact_line(cfg)
    return cfg
