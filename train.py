...
def trade_last_tail_block_for_24x_tail_mlp_on_compact_seq768_line(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 2 or model_cfg.tail_layers != 2:
        return
    if model_cfg.mlp_mult != 2 or model_cfg.shared_mlp_hidden_bonus != (model_cfg.d_model * 3) // 8:
    ...
    if cfg.train_batch_tokens != 122_880 or cfg.val_batch_tokens != 122_880:
        return
    model_cfg.tail_layers = 1
    model_cfg.non_recurrent_mlp_hidden_bonus = model_cfg.d_model * 22
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    trade_last_tail_block_for_24x_tail_mlp_on_compact_seq768_line(cfg)
    return cfg
