...
def pair_shared_carrier_float_with_shared_and_final_tail_mlp_qat_relaxation_on_tied_embed_final_tail_q_line(
    cfg: TrainConfig,
) -> None:
    model_cfg = cfg.model
    if not model_cfg.tie_embeddings:
    ...
    if "tok_emb.weight" not in cfg.quant.keep_float_name_patterns:
        return
    new_patterns = ("shared.0.attn.", "shared.0.mlp.")
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    pair_shared_carrier_float_with_shared_and_final_tail_mlp_qat_relaxation_on_tied_embed_final_tail_q_line(cfg)
    return cfg
