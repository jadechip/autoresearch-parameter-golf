...
def reallocate_low_rank_q_into_five_block_carrier_on_flattened_near_cap_line(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if not model_cfg.tie_embeddings or model_cfg.final_tail_smear_gate:
        return
    ...
    model_cfg.non_recurrent_mlp_hidden_bonus = (model_cfg.d_model * 13) // 4
    cfg.quant.keep_float_name_patterns = (
        "norm",
        "scale",
        "gain",
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    reallocate_low_rank_q_into_five_block_carrier_on_flattened_near_cap_line(cfg)
    return cfg
