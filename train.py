...
def reclaim_compute_into_dmodel480_four_block_frontloaded_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if not model_cfg.tie_embeddings or model_cfg.final_tail_smear_gate:
        return
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 0 or model_cfg.recurrence_loops != 0 or model_cfg.tail_layers != 3:
    ...
    model_cfg.q_low_rank = model_cfg.d_model // 4
    model_cfg.tail_layers = 4
    model_cfg.non_recurrent_mlp_hidden_bonus = 2560
    model_cfg.tail_mlp_hidden_bonuses = (3072, 2816, 2560, 2304)
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    reclaim_compute_into_dmodel480_four_block_frontloaded_carrier(cfg)
    return cfg
