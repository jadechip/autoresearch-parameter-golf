...
def start_fake_quant_from_step_zero_on_accepted_deep_tail(model_cfg: ModelConfig) -> None:
    if model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 2 or model_cfg.tail_layers != 7:
        return
    ...
    if model_cfg.fake_quant_start_step != 20:
        return
    model_cfg.fake_quant_start_step = 0
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    start_fake_quant_from_step_zero_on_accepted_deep_tail(cfg.model)
    return cfg
