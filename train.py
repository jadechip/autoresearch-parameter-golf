...
def add_final_tail_xsa_on_near_cap_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    ...
    if not math.isclose(cfg.quant.clip_percentile, 96.5, rel_tol=0.0, abs_tol=1e-9):
        return
    model_cfg.final_tail_xsa_rank = model_cfg.d_model // 8
    model_cfg.final_tail_xsa_window = 32
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    add_final_tail_xsa_on_near_cap_carrier(cfg)
    return cfg
