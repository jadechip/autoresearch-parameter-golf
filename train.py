...
def build_distributed_canon_shared_trunk_carrier_on_branch_tip(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    ...
    model_cfg.canon_rank = model_cfg.d_model * 3 // 16
    model_cfg.stem_canon_layers = (0,)
    model_cfg.shared_canon_layers = (1, 3)
    model_cfg.tail_canon_layers = (1,)
    model_cfg.fake_quant_start_step = cfg.train_seq_len_warmup_steps
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    build_distributed_canon_shared_trunk_carrier_on_branch_tip(cfg)
    return cfg
