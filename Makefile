...
.PHONY: install install-cpu smoke-data smoke-train smoke download-data train-5090 autoresearch-baseline watch-latest monitor-latest tensorboard-autoresearch compare-autoresearch
