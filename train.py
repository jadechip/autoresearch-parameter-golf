...
def lift_context_to_768_on_int6_stemless_deep_tail(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 2 or model_cfg.tail_layers != 8:
        return
    ...
    if cfg.optim.warmdown_steps != 80:
        return
    if cfg.train_batch_tokens != 131072 or cfg.val_batch_tokens != 131072 or cfg.grad_accum_steps != 4:
        return
    model_cfg.seq_len = 768
    cfg.train_batch_tokens = 129024
    cfg.val_batch_tokens = 129024
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    lift_context_to_768_on_int6_stemless_deep_tail(cfg)
    return cfg
