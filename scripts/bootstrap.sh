...
echo "  make train-h100-1x"
echo "  make train-h100-8x"
echo "  make eval-h100-1x"
echo "  make eval-h100-8x"
echo "  make package-submission RESULTS_JSON=./runs/runpod_h100_8x_10min/<run>/results.json"
echo "  make autoresearch-baseline"
echo "  make init-autoresearch-session"
echo "  make codex-autoresearch-loop"
echo "  make watch-codex-loop"
echo "  make tensorboard-autoresearch"
