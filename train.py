...
def rebalance_tied_embed_final_tail_q_line_into_two_shared_two_tail_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if not model_cfg.tie_embeddings:
        return
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 1 or model_cfg.tail_layers != 3:
    ...
    model_cfg.tail_layers = 2
    model_cfg.non_recurrent_mlp_hidden_bonus = model_cfg.d_model * 9
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    rebalance_tied_embed_final_tail_q_line_into_two_shared_two_tail_carrier(cfg)
    return cfg
