...
def extend_warmdown_on_modestly_widened_wallclock_deep_tail(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if model_cfg.shared_layers != 1 or model_cfg.recurrence_loops != 2 or model_cfg.tail_layers != 7:
        return
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    extend_warmdown_on_modestly_widened_wallclock_deep_tail(cfg)
    return cfg
