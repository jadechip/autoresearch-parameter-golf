...
def restore_penultimate_tail_mlp_fake_quant_on_neighbor_mixer_three_block_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    restore_penultimate_tail_mlp_fake_quant_on_neighbor_mixer_three_block_carrier(cfg)
    return cfg
