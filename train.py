...
def replace_branch_tip_neighbor_carrier_with_dual_canon_twelve_layer_branch(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    replace_branch_tip_neighbor_carrier_with_dual_canon_twelve_layer_branch(cfg)
