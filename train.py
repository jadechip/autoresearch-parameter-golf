...
def repartition_shared_float_smear_gate_compact_line_into_tail4_6x(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    repartition_shared_float_smear_gate_compact_line_into_tail4_6x(cfg)
    return cfg
