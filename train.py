...
def replace_branch_tip_neighbor_path_with_upper_tail_canon_eleven_layer_branch(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    ...
    model_cfg.tail_canon_layers = (5, 6)
    model_cfg.fake_quant_start_step = cfg.train_seq_len_warmup_steps
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    replace_branch_tip_neighbor_path_with_upper_tail_canon_eleven_layer_branch(cfg)
