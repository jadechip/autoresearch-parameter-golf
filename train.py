...
def build_low_rank_q_canon_twelve_layer_carrier_on_branch_tip(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    ...
    model_cfg.tail_mlp_hidden_bonuses = (
        model_cfg.d_model + model_cfg.d_model // 4,
        model_cfg.d_model + model_cfg.d_model // 2,
        model_cfg.d_model + model_cfg.d_model * 3 // 4,
        model_cfg.d_model * 2,
        model_cfg.d_model * 2 + model_cfg.d_model // 4,
        model_cfg.d_model * 2 + model_cfg.d_model // 2,
    )
    model_cfg.canon_rank = model_cfg.d_model // 4
    model_cfg.stem_canon_layers = None
    model_cfg.shared_canon_layers = (2,)
    model_cfg.tail_canon_layers = (2, 5)
    model_cfg.fake_quant_start_step = cfg.train_seq_len_warmup_steps
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    build_low_rank_q_canon_twelve_layer_carrier_on_branch_tip(cfg)
