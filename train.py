...
def extend_branch_tip_more_updates_carrier_into_640_to_896_curriculum(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
    if not model_cfg.final_tail_neighbor_mixer or not model_cfg.tie_embeddings or model_cfg.final_tail_smear_gate:
        return
    if model_cfg.stem_layers != 0 or model_cfg.shared_layers != 0 or model_cfg.recurrence_loops != 0 or model_cfg.tail_layers != 3:
    ...
    model_cfg.fake_quant_start_step = 192
    model_cfg.tail_q_low_ranks = (
        model_cfg.d_model // 8,
        model_cfg.d_model // 8,
        0,
    )
    cfg.train_batch_tokens = 53_760
    cfg.train_seq_len_warmup_steps = 192
    cfg.quant.keep_float_name_patterns = (
        "norm",
        "scale",
        "gain",
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    extend_branch_tip_more_updates_carrier_into_640_to_896_curriculum(cfg)
