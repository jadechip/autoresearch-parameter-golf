...
def reallocate_low_rank_q_into_wider_tail_on_recovered_compact_line(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    reallocate_low_rank_q_into_wider_tail_on_recovered_compact_line(cfg)
    return cfg
