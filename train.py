...
def add_final_tail_neighbor_mixer_on_three_block_near_cap_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    add_final_tail_neighbor_mixer_on_three_block_near_cap_carrier(cfg)
    return cfg
