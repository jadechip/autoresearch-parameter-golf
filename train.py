...
def add_final_tail_smear_gate_on_front_loaded_three_block_carrier(cfg: TrainConfig) -> None:
    model_cfg = cfg.model
...
def config_from_args(args: argparse.Namespace) -> TrainConfig:
    ...
    add_final_tail_smear_gate_on_front_loaded_three_block_carrier(cfg)
    return cfg
